...
declare const _sfc_main: import("vue").DefineComponent<{
    ...
    heatmap: import("vue").Ref<{
        ...
        readonly activities: Map<string, {
            count: number;
            colorIndex: number;
        }> & Omit<import('../components/Heatmap').Activities, keyof Map<any, any>>;
...
}, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, "dayClick"[], "dayClick", import("vue").PublicProps, Readonly<import("vue").ExtractPropTypes<{
    endDate: {
        required: true;
    };
    max: {
